...
?>
    ...
    <script>
        ...
        var myOptions = {
            zoom: 12,
            center: new google.maps.LatLng(43.235073, 76.909744),
            mapTypeId: 'roadmap'
        };
        ...
        var addMarker = google.maps.event.addListener(map, 'click', function(e) {
            ...
            var marker = new google.maps.Marker({
                ...
                "            <tr>\n" +
                "                <td><a>Address:</a></td>\n" +
                "                <td><textarea  id='manual_description' placeholder='Please Enter Your Address'></textarea></td></tr>\n" +
        ...
        function saveData(lat,lng) {
            ...
            downloadUrl(url, function(data, responseCode) {
                ...
                if (responseCode === 200  && data.length > 1) {
                    ...
                    infowindow.close();
                    infowindow.setContent("<div style=' color: purple; font-size: 25px;'>Waiting for the Staff Receive!!</div>");
